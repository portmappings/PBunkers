package me.portmapping.pbunkers.tablist.packet;

import io.netty.channel.Channel;
import me.portmapping.pbunkers.tablist.protocol.Reflection;
import me.portmapping.pbunkers.tablist.protocol.TinyProtocol;
...
public class TabPacket extends TinyProtocol {
  ...
  public Object onPacketOutAsync(Player reciever, Channel channel, Object object) {
    if (object instanceof PacketPlayOutScoreboardTeam) {
      ...
      int value = Reflection.getField(scoreboardTeam.getClass(), "h", int.class)
          .get(scoreboardTeam);
      String teamName = Reflection.getField(scoreboardTeam.getClass(), "a", String.class)
          .get(scoreboardTeam);

      if (value == 4 && !teamName.equalsIgnoreCase("tab")) {
        Reflection.getField(scoreboardTeam.getClass(), "a", String.class)
            .set(scoreboardTeam, "tab");
        Reflection.getField(scoreboardTeam.getClass(), "b", String.class)
            .set(scoreboardTeam, "tab");
