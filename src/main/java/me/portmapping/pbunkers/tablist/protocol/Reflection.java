...
public final class Reflection {
  ...
  private static final String NMS_PREFIX = OBC_PREFIX.replace("org.bukkit.craftbukkit",
      "net.minecraft.server");
  private static final String VERSION = OBC_PREFIX.replace("org.bukkit.craftbukkit", "")
      .replace(".", "");
  ...
  // Common method
  private static <T> FieldAccessor<T> getField(Class<?> target, String name, Class<T> fieldType,
      int index) {
   ...
   * <p>
   * Strings enclosed with curly brackets - such as {TEXT} - will be replaced according to the
   * following table:
   * <p>
   * <table border="1">
   * <tr>
