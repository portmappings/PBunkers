package me.portmapping.pbunkers.utils.chat;
...
public class CC {
    ...
    public static final String UNICODE_VERTICAL_BAR = ChatColor.GRAY + StringEscapeUtils.unescapeJava("\u2503");
    ...
    public static String getColorName(ChatColor color) {
        return StringUtils.capitalize(color.name().toLowerCase().replace("_", " "));
    }

    public static final String PRIMARY = "§c";
    public static final String SECONDARY = "§e";
    public static final String EXTRA = "§7";

    public static final String LINE = CC.translate("&7&m------------------");
