...
public class MatchEnterClaimEvent extends Event implements Cancellable {
    ...
    public MatchEnterClaimEvent(Player player, Location from, Location to, Team fromTeam, Team toTeam) {
        this.player = player;
        this.from = from;
        this.to = to;
